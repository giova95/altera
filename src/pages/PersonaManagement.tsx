      ...
      <header className="border-b border-border/50 bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Button onClick={() => navigate('/workspace')} variant="ghost" size="sm">
              My Workspace
            </Button>
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage and refine AI personas for employees who have consented to use them for
          ...
          <CardContent className="flex items-start gap-3 p-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                AI personas are designed for communication practice and coaching. The traits and
                context you add here help create more realistic simulations. This data should not be
                used as formal performance evaluation.
              </p>
            </div>
          </CardContent>
        </Card>
